...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_{{ cookiecutter.project_name }}``)
...
* For convenience, the package version is stored in a single place: ``{{ cookiecutter.project_name }}/__version__.py``. For updating the version number, you only have to change this file.
